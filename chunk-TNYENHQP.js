...
var _PlaygroundComponent = class _PlaygroundComponent {
  ...
  constructor() {
    ...
    forkJoin({
      ...
      embeddedEditorComponent: import("./chunk-PJWF6GGR.js").then((c) => c.EmbeddedEditor)
  ...
  async loadTemplate(tutorialPath) {
    const embeddedTutorialManager = await injectAsync(this.environmentInjector, () => import("./chunk-PJWF6GGR.js").then((c) => c.EmbeddedTutorialManager));
 ...
 */
//# sourceMappingURL=chunk-TNYENHQP.js.map
