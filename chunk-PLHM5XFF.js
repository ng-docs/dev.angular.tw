...
// src/content/examples/animations/src/app/animations-package/insert-remove.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InsertRemoveComponent, [{
    ...
    ], template: '<!-- #docplaster -->\n\n<h2>Insert/Remove</h2>\n\n<nav>\n  <button type="button" (click)="toggle()">Toggle Insert/Remove</button>\n</nav>\n\n@if (isShown) {\n  <div @myInsertRemoveTrigger class="insert-remove-container">\n    <p>The box is inserted</p>\n  </div>\n}\n', styles: ["/* src/content/examples/animations/src/app/animations-package/insert-remove.component.css */\n:host {\n  display: block;\n}\n.insert-remove-container {\n  border: 1px solid #dddddd;\n  margin-top: 1em;\n  padding: 20px 20px 0px 20px;\n  color: #000000;\n  font-weight: bold;\n  font-size: 20px;\n}\n/*# sourceMappingURL=insert-remove.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(InsertRemoveComponent, { className: "InsertRemoveComponent", filePath: "src/content/examples/animations/src/app/animations-package/insert-remove.component.ts", lineNumber: 16 });
})();
export {
  InsertRemoveComponent
};
//# sourceMappingURL=chunk-PLHM5XFF.js.map
