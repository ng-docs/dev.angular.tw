...
__publicField(_AppComponent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 6, vars: 2, consts: [["for", "progress-value"], ["id", "progress-value", "type", "number", "min", "0", "max", "100", 3, "input", "value"], ["aria-label", "進度條範例", 3, "value"]], template: /* @__PURE__ */ __name(function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "h1");
