...
WARNING: This link could potentially be dangerous`)) {
        ...
        const _c = class _c extends a.Disposable {
          constructor() {
        ...
        const _c = class _c extends n.AttributeData {
          constructor(e3, t3, i3) {
        ...
        let c = _c;
        t2.JoinedCellData = c;
        let l = t2.CharacterJoinerService = (_a = class {
          constructor(e3) {
            this._bufferService = e3, this._characterJoiners = [], this._nextCharacterJoinerId = 0, this._workCell = new a.CellData();
          }
          register(e3) {
          ...
          getJoinedCharacters(e3) {
            ...
            for (let e4 = 0; e4 < t3.getTrimmedLength(); e4++) if (t3.loadCell(e4, this._workCell), 0 !== this._workCell.getWidth()) {
              if (this._workCell.fg !== h2 || this._workCell.bg !== c2) {
                ...
                r2 = e4, a2 = n2, h2 = this._workCell.fg, c2 = this._workCell.bg;
              }
              n2 += this._workCell.getChars().length || o.WHITESPACE_CELL_CHAR.length;
            }
            if (this._bufferService.cols - r2 > 1) {
              const e4 = this._getJoinedRanges(s3, a2, n2, t3, r2);
          ...
          _getJoinedRanges(t3, i3, s3, r2, n2) {
            ...
            for (let t4 = 1; t4 < this._characterJoiners.length; t4++) try {
              ...
              for (let t5 = 0; t5 < i4.length; t5++) _a._mergeRanges(a2, i4[t5]);
            } catch (e3) {
              console.error(e3);
            }
          ...
          _stringRangesToCellRanges(e3, t3, i3) {
            let s3 = 0, r2 = false, n2 = 0, a2 = e3[s3];
            if (a2) {
        ...
        const _a = class _a extends s2.Disposable {
          constructor(e3) {
        ...
        Object.defineProperty(t2, "__esModule", { value: true }), t2.getDisposeArrayDisposable = t2.disposeArray = t2.toDisposable = t2.MutableDisposable = t2.Disposable = void 0, t2.Disposable = class {
          ...
          return { dispose: /* @__PURE__ */ __name(() => i2(e3), "dispose") };
        };
      }, 1505: (e2, t2) => {
        ...
        const _n = class _n {
          ...
          constructor(e3) {
            this.line = e3, this.isDisposed = false, this._disposables = [], this._id = _n._nextId++, this._onDispose = this.register(new s2.EventEmitter()), this.onDispose = this._onDispose.event;
          }
          dispose() {
        ...
        t2.DcsParser = class {
          ...
          registerHandler(e3, t3) {
            ...
            return i3.push(t3), { dispose: /* @__PURE__ */ __name(() => {
        ...
        t2.VT500_TRANSITION_TABLE = (function() {
          const e3 = new a(4095), t3 = Array.apply(null, Array(256)).map(((e4, t4) => t4)), i3 = /* @__PURE__ */ __name((e4, i4) => t3.slice(e4, i4), "i"), s3 = i3(32, 127), r2 = i3(0, 24);
        ...
        const _c = class _c extends s2.Disposable {
        ...
        const _s = class _s {
          ...
          clone() {
            const e3 = new _s(this.maxLength, this.maxSubParamsLength);
        ...
        let a = 0, h = 0;
        const _c = class _c extends n.Disposable {
          get decorations() {
        ...
        const _a = class _a extends r.Disposable {
          constructor(e3) {
        ...
        const _n = class _n {
          ...
          getStringCellWidth(e3) {
            ...
            for (let r2 = 0; r2 < s3; ++r2) {
              ...
              _n.extractShouldJoin(a) && (h -= _n.extractWidth(i3)), t3 += h, i3 = a;
            }
            return t3;
          }
          charProperties(e3, t3) {
      ...
      return (() => {
        ...
        const _d = class _d extends n.Disposable {
          constructor(e3) {
            ...
            const t3 = /* @__PURE__ */ __name((e4) => this._core.options[e4], "t"), i2 = /* @__PURE__ */ __name((e4, t4) => {
...
// src/app/editor/alert-manager.service.ts
var MAX_RECOMMENDED_WEBCONTAINERS_INSTANCES = 3;
var WEBCONTAINERS_COUNTER_KEY = "numberOfWebcontainers";
var AlertReason;
(function(AlertReason2) {
  AlertReason2[AlertReason2["OUT_OF_MEMORY"] = 0] = "OUT_OF_MEMORY";
  AlertReason2[AlertReason2["MOBILE"] = 1] = "MOBILE";
})(AlertReason || (AlertReason = {}));
var _AlertManager = class _AlertManager {
...
// src/app/editor/enums/loading-steps.ts
var LoadingStep;
(function(LoadingStep2) {
  LoadingStep2[LoadingStep2["NOT_STARTED"] = 0] = "NOT_STARTED";
  LoadingStep2[LoadingStep2["BOOT"] = 1] = "BOOT";
  LoadingStep2[LoadingStep2["LOAD_FILES"] = 2] = "LOAD_FILES";
  LoadingStep2[LoadingStep2["INSTALL"] = 3] = "INSTALL";
  LoadingStep2[LoadingStep2["START_DEV_SERVER"] = 4] = "START_DEV_SERVER";
  LoadingStep2[LoadingStep2["READY"] = 5] = "READY";
  LoadingStep2[LoadingStep2["ERROR"] = 6] = "ERROR";
})(LoadingStep || (LoadingStep = {}));

// src/app/editor/node-runtime-errors.ts
var DEV_SERVER_READY_MSG = "Watch mode enabled. Watching for file changes...";
var OUT_OF_MEMORY_MSG = "Out of memory";

// src/app/editor/node-runtime-state.service.ts
var ErrorType;
(function(ErrorType2) {
  ErrorType2[ErrorType2["UNKNOWN"] = 0] = "UNKNOWN";
  ErrorType2[ErrorType2["COOKIES"] = 1] = "COOKIES";
  ErrorType2[ErrorType2["OUT_OF_MEMORY"] = 2] = "OUT_OF_MEMORY";
  ErrorType2[ErrorType2["UNSUPPORTED_BROWSER_ENVIRONMENT"] = 3] = "UNSUPPORTED_BROWSER_ENVIRONMENT";
})(ErrorType || (ErrorType = {}));
var _NodeRuntimeState = class _NodeRuntimeState {
  _loadingStep = signal(LoadingStep.NOT_STARTED, ...ngDevMode ? [{ debugName: "_loadingStep" }] : []);
  loadingStep = this._loadingStep.asReadonly();
  _isResetting = signal(false, ...ngDevMode ? [{ debugName: "_isResetting" }] : []);
  isResetting = this._isResetting.asReadonly();
  _error = signal(void 0, ...ngDevMode ? [{ debugName: "_error" }] : []);
...
// src/app/editor/terminal/terminal-handler.service.ts
...
var _InteractiveTerminal = class _InteractiveTerminal extends import_xterm.Terminal {
  window;
  commandValidator;
  breakProcess = new Subject();
  // Using this stream, the webcontainer shell can break current process.
  breakProcess$ = this.breakProcess.asObservable();
  constructor(window2, commandValidator) {
  ...
  handleCommandExecution() {
    ...
    this.attachCustomKeyEventHandler((event) => {
      ...
      if (event.key === "Enter") {
        let terminalContent = Array.from(this.element.querySelectorAll(".xterm-rows>div")).map((lines) => Array.from(lines.querySelectorAll("span:not(.xterm-fg-6)")).map((part) => part.textContent).join("").trim()).filter((line) => !!line && line.startsWith(commandLinePrefix));
        let command = terminalContent.length > 0 ? terminalContent[terminalContent.length - 1].replace(commandLinePrefix, "").trim() : "";
...
__name(_InteractiveTerminal, "InteractiveTerminal");
var InteractiveTerminal = _InteractiveTerminal;

// src/app/editor/terminal/command-validator.service.ts
...
var _CommandValidator = class _CommandValidator {
...
(function(TerminalType2) {
  TerminalType2[TerminalType2["READONLY"] = 0] = "READONLY";
  TerminalType2[TerminalType2["INTERACTIVE"] = 1] = "INTERACTIVE";
})(TerminalType || (TerminalType = {}));
var _TerminalHandler = class _TerminalHandler {
  window = inject(WINDOW);
  ...
  terminals = {
    ...
    [TerminalType.READONLY]: signal({
      instance: new import_xterm2.Terminal({ convertEol: true, disableStdin: true }),
      fitAddon: new import_addon_fit.FitAddon()
    }),
...
// src/app/editor/typings-loader.service.ts
var _TypingsLoader = class _TypingsLoader {
  ...
  webContainer;
  _typings = signal([], ...ngDevMode ? [{ debugName: "_typings" }] : []);
  ...
  async getFilesToRead() {
    ...
    for (const library of this.librariesToGetTypesFrom) {
      const packageJsonContent = await this.webContainer.fs.readFile(`./node_modules/${library}/package.json`, "utf-8").catch((error) => {
        if (error?.message.startsWith("ENOENT")) {
          return;
        }
        throw error;
...
// src/app/editor/node-runtime-sandbox.service.ts
var PACKAGE_MANAGER = "npm";
var _NodeRuntimeSandbox = class _NodeRuntimeSandbox {
  _createdFile$ = new Subject();
  createdFile$ = this._createdFile$.asObservable();
  _createdFiles = signal(/* @__PURE__ */ new Set(), ...ngDevMode ? [{ debugName: "_createdFiles" }] : []);
  ...
  _isProjectInitialized = signal(false, ...ngDevMode ? [{ debugName: "_isProjectInitialized" }] : []);
  _isAngularCliInitialized = signal(false, ...ngDevMode ? [{ debugName: "_isAngularCliInitialized" }] : []);
  ...
  constructor() {
    effect(() => {
      ...
      terminal.breakProcess$.subscribe(() => {
        this.interactiveShellWriter?.write("");
      });
    });
  }
  get previewUrl$() {
  ...
  async getSolutionFiles() {
    ...
    return await checkFilesInDirectory("", webContainer.fs, (path) => !excludeFromRoot.includes(path));
  }
  /**
  ...
  handleProjectChanges() {
    this.embeddedTutorialManager.tutorialChanged$.pipe(map((tutorialChanged) => ({
      tutorialChanged,
      tutorialFiles: this.embeddedTutorialManager.tutorialFiles()
    })), filter(({ tutorialChanged, tutorialFiles }) => tutorialChanged && Object.keys(tutorialFiles).length > 0), takeUntilDestroyed(this.destroyRef)).subscribe(async () => {
  ...
  async handleFilesToDeleteOnProjectChange() {
    const filesToDelete = Array.from(/* @__PURE__ */ new Set([
    ...
    this._createdFiles.set(/* @__PURE__ */ new Set());
  }
  ...
  async mountProjectFiles() {
    ...
    const tutorialHasFiles = Object.keys(this.embeddedTutorialManager.tutorialFilesystemTree()).length > 0;
    if (tutorialHasFiles) {
      await Promise.all([
  ...
  terminate(webContainer) {
    ...
    this.webContainerPromise = void 0;
  }
  ...
  async installDependencies() {
    ...
    this.interactiveShellWriter?.write("\r");
    return code;
  }
  async loadTypes() {
    const webContainer = await this.webContainerPromise;
    ...
    await new Promise((resolve, reject) => {
      ...
      this.devServerProcess.output.pipeTo(new WritableStream({
        write: /* @__PURE__ */ __name((data) => {
          ...
          if (this.nodeRuntimeState.loadingStep() !== LoadingStep.READY && data.toString().includes(DEV_SERVER_READY_MSG)) {
            resolve();
            this.setLoading(LoadingStep.READY);
          }
        }, "write")
  ...
  async spawn(command, args = []) {
    const webContainer = await this.webContainerPromise;
    const process2 = await webContainer.spawn(command, args);
    ...
    process2.output = process2.output.pipeThrough(transformStream);
  ...
  async killExistingProcesses() {
    await Promise.all(Array.from(this.processes).map((process2) => process2.kill()));
 ...
 */
//# sourceMappingURL=chunk-4CBXRCG6.js.map
