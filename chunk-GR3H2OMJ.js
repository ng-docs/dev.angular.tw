...
var _PlaygroundComponent = class _PlaygroundComponent {
  ...
  constructor() {
    ...
    forkJoin({
      ...
      embeddedEditorComponent: import("./chunk-HSQ5A5G3.js").then((c) => c.EmbeddedEditor)
  ...
  async loadTemplate(tutorialPath) {
    const embeddedTutorialManager = await injectAsync(this.environmentInjector, () => import("./chunk-HSQ5A5G3.js").then((c) => c.EmbeddedTutorialManager));
 ...
 */
//# sourceMappingURL=chunk-GR3H2OMJ.js.map
